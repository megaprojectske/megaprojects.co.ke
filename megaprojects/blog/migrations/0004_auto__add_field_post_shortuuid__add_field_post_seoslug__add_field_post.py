...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.shortuuid'
        db.add_column(u'blog_post', 'shortuuid',
        ...
        # Adding field 'Post.reviewed'
        db.add_column(u'blog_post', 'reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Image.shortuuid'
        db.add_column(u'blog_image', 'shortuuid',
                      self.gf('core.fields.ShortUUIDField')(max_length=22, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.shortuuid'
        db.delete_column(u'blog_post', 'shortuuid')

        # Deleting field 'Post.slug'
        db.delete_column(u'blog_post', 'slug')

        # Deleting field 'Post.reviewed'
        db.delete_column(u'blog_post', 'reviewed')

        # Deleting field 'Image.shortuuid'
        db.delete_column(u'blog_image', 'shortuuid')
    ...
    models = {
        ...
        u'blog.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pubdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 18, 0, 0)'}),
            'reviewed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'shortuuid': ('core.fields.ShortUUIDField', [], {'max_length': '22', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
