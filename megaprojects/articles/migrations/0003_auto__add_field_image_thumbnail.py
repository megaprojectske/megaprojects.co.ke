...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'articles_image', 'thumbnail',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'articles_image', 'thumbnail')
    ...
    models = {
        u'articles.article': {
            ...
            'pubdate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 6, 0, 0)'}),
