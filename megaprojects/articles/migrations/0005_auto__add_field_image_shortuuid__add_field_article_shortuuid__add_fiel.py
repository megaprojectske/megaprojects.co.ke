...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'articles_image', 'shortuuid',
                      self.gf('core.fields.ShortUUIDField')(max_length=22, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.shortuuid'
        db.add_column(u'articles_article', 'shortuuid',
                      self.gf('core.fields.ShortUUIDField')(max_length=22, unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'articles_image', 'shortuuid')

        # Deleting field 'Article.shortuuid'
        db.delete_column(u'articles_article', 'shortuuid')
