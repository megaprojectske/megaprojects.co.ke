...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'programs_image', 'reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Program.reviewed'
        db.add_column(u'programs_program', 'reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'programs_image', 'reviewed')

        # Deleting field 'Program.reviewed'
        db.delete_column(u'programs_program', 'reviewed')
